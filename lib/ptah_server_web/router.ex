defmodule PtahServerWeb.Router do
  ...
  scope "/", PtahServerWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{PtahServerWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", PtahServerWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{PtahServerWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", PtahServerWeb do
    ...
    live_session :current_user,
      on_mount: [{PtahServerWeb.UserAuth, :mount_current_user}] do

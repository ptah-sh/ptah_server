defmodule PtahServerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PtahServerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PtahServerWeb.Gettext, "errors", msg, opts)
    end
  end
